...
//  PopLock
//
//  Created by Katelyn Gosnell on 5/5/23.
//
...
extension GameScene {
    func clearPin() {
        ...
        collectible.run(.sequence([
            ...
            .playSoundFileNamed("PopTheLock_pop.m4a   ", waitForCompletion: false),
    ...
    func moveLock() {
        ...
        lockTop.run(.sequence([
            ...
            .playSoundFileNamed("PopTheLock_unlock.mp3", waitForCompletion: false),
            lockMoveDown,
            lockMoveUp]))
    ...
    func endGame() {
        run(.sequence([.playSoundFileNamed("PopTheLock_unlock.mp3", waitForCompletion: false),
        ...
        let particle = SKEmitterNode(fileNamed: "MagicWork")!
